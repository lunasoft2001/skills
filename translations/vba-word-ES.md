...
Extraer todos los módulos VBA de documentos Word con macros (`.docm` / `.dotm`), refactorizarlos en VS Code y reimportarlos de forma segura — creando siempre una copia de seguridad con marca de tiempo antes de cualquier importación.
