...
Extract all VBA modules from Word macro-enabled documents (`.docm` / `.dotm`), refactor them in VS Code, and safely re-import them — always creating a timestamped backup before any import.
